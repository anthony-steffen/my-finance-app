...
function BillsToPay() {
  return (
    <section className="expense-container mt-1 mb-0">
      <h5 className="expense-title mt-2 mb-0">Contas a Pagar</h5>
      <ul className="list-group list-group-light">
        <li className="list-group-item d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            ...
            />
            <div className="ms-3">
              <p className="fw-bold mb-0">Anthony</p>
        ...
        <li className="list-group-item d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            ...
            />
            <div className="ms-3">
              <p className="fw-bold mb-0">Alex Ray</p>
        ...
        <li className="list-group-item d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            ...
            />
            <div className="ms-3">
              <p className="fw-bold mb-0">Kate Hunington</p>
